#!/usr/bin/env python3
"""
Quick start example for LLMBridge.
...
import asyncio
import os
from llmbridge import LLMBridge, LLMRequest, Message
...
async def example_with_sqlite():
    ...
    # Create service with SQLite (auto-creates llmbridge.db)
...
async def main():
    """Run all examples."""
    print("🚀 LLMBridge Quick Start Examples")
    print("=" * 50)

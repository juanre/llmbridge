"""Test configuration and fixtures for llmbridge"""
...
async def llm_test_db(test_db_factory):
    ...
    # Create database for llmbridge schema
    db_manager = await test_db_factory.create_db(suffix="llm", schema="llmbridge")
...
@pytest.fixture
async def llmbridge_with_db(llm_test_db):
    """Create LLMBridge instance with test database"""
...
@pytest.fixture
async def llmbridge_no_db():
    """Create LLMBridge instance without database logging"""

...
async def test_service_with_database(llmbridge_with_db, simple_user_message):
    """Test LLMBridge with database logging enabled."""
    service = llmbridge_with_db
...
def test_service_without_database(llmbridge_no_db):
    """Test LLMBridge without database logging."""
    service = llmbridge_no_db

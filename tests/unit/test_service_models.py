...
class TestLLMBridgeModelMethods:
    """Unit tests for LLMBridge model retrieval methods."""
    ...
    @pytest.fixture
    def llmbridge_with_mock_db(self, mock_db):
        """Create LLMBridge with mocked database."""
        service = LLMBridge(enable_db_logging=True)
        service.db = mock_db
        return service
    ...
    async def test_get_models_from_db_success(
        self, llmbridge_with_mock_db, sample_models
    ):
        """Test successful model retrieval from database."""
        service = llmbridge_with_mock_db
    ...
    @pytest.mark.asyncio
    async def test_get_models_from_db_error_handling(self, llmbridge_with_mock_db):
    ...
    @pytest.mark.asyncio
    async def test_get_model_from_db_not_found(self, llmbridge_with_mock_db):
    ...
    @pytest.mark.asyncio
    async def test_get_model_from_db_error_handling(self, llmbridge_with_mock_db):
    ...
    @pytest.mark.asyncio
    async def test_database_initialization_only_once(self, llmbridge_with_mock_db):
    ...
    async def test_logging_in_model_methods(
        self, llmbridge_with_mock_db, sample_models, caplog
    ):
